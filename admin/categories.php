<?php
    ...
    if (isset($_GET['delete']) && !empty($_GET['delete']))
    {
        ...
        {
            $sql = "DELETE FROM categpries WHERE parent='$delete_id'";
            $db->query($sql);
        }
        $dsql = "DELETE FROM categories WHERE id = '$delete_id'";
        $db->query($dsql);
        header('Location : categpries.php');
    }
    // Process Form
    ...
    <div class="col-md-6">
        <form class="form" action="categories.php<?=((isset($_GET['edit']))?'?edit='.$edit_id:'');?>" method="post">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="category" name="category" value="<?=$category_values;?>">
            </div>
            <div class="form-group">
